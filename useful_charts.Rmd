...
This table provides a clean representation of what I wish to investigate throughout this document - namely, the continued increase in strikeouts in Major League Baseball since 2007.
...
full_savant_data %>%
  ...
  ggplot(aes(x = factor(game_year))) +
  geom_violin(aes(y = release_speed), draw_quantiles = 0.5) +
